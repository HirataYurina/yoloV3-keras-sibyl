...
from yolo_asff.yolo_asff_body import yolo_asff_body
from nets.yolo3_loss import yolo_loss
...
from yolo_asff.configs import CONFIG
...
if __name__ == "__main__":
    ...
    model_body = yolo_asff_body(image_input, num_anchors // 3, num_classes)
    ...
    model_loss = Lambda(yolo_loss, output_shape=(1,), name='yolo_loss',
                        arguments={'anchors': anchors,
                                   ...
                                   'use_diou': CONFIG.TRAIN.USE_DIOU,
                                   'use_ciou': CONFIG.TRAIN.USE_CIOU,
    ...
    if True:
        model.compile(optimizer=Adam(lr=CONFIG.TRAIN.LR_STAGE),
                      loss={'yolo_loss': lambda y_true, y_pred: y_pred})

        batch_size = CONFIG.TRAIN.BATCH

        # cosine anneal
        total_epoch = CONFIG.TRAIN.EPOCH
        cosine_anneal = WarmUpCosineDecayScheduler(learning_rate_base=CONFIG.TRAIN.LR_STAGE,
