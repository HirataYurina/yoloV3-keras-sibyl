...
from gaussion_yolo3.gaussian_yolo3 import yolo_body
from gaussion_yolo3.gaussian_yolo3_loss import gaussian_yolo_loss
...
if __name__ == "__main__":
    ...
    model_loss = Lambda(gaussian_yolo_loss, output_shape=(1,), name='yolo_loss',
